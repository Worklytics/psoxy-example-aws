...
module "cognito_identity_pool" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/aws-cognito-pool?ref=v0.4.37"
...
module "cognito_identity" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/aws-cognito-identity-cli?ref=v0.4.37"
