...
module "worklytics_connectors_msft_365" {
  source = "git::https://github.com/worklytics/psoxy//infra/modules/worklytics-connectors-msft-365?ref=v0.4.33"
...
module "cognito_identity_pool" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/aws-cognito-pool?ref=v0.4.33"
...
module "cognito_identity" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/aws-cognito-identity-cli?ref=v0.4.33"
...
module "msft_connection_auth_federation" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/azuread-federated-credentials?ref=v0.4.33"
