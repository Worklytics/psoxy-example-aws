...
module "psoxy" {
  source = "git::https://github.com/worklytics/psoxy//infra/modules/aws-host?ref=v0.4.43"
...
module "connection_in_worklytics" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/worklytics-psoxy-connection-aws?ref=v0.4.43"
